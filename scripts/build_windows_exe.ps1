...
Write-Host "=== SuperForge Windows package build ==="
...
& .\.venv\Scripts\pyinstaller.exe --clean --noconfirm .\SuperForge.spec

$package = Join-Path $repo "dist\SuperForge.exe"
...
Write-Host "SuperForge package ready: $package"
